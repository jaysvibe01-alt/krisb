...
**결정 근거:**
- 청산 위험 시뮬: 30x → 연 48건 청산 (운영 불가) / **10x → 연 1건 (안전)**
- Kris 본인 강의 추천 배율: **0건 명시** (PPT/LAB/텔레그램 전체 통독)
- 결함 5개 발견 후 보수 노선 채택 (서브에이전트 검증)

- **시드:** $300
- **레버리지:** **10배** ⭐
- **포지션당 자본:** 50% ($150)
- **거래당 리스크 (SL 1회):** -$10.5 (자본 3.5%)
- **청산 거리:** -9.5% (SL 0.7% 대비 13.6배 안전)
- **연간 청산 추정:** **1건/년**
- **종목 (29종):** BTC/ETH/SOL/XRP/DOGE/LINK/ADA/AVAX/SUI/BNB/TON/HYPE/BCH/FIL/ARB/LTC/OP/DOT/ETC/AAVE/ENA/PENGU/NEAR/APT/SEI/INJ/TIA/WIF/ZEC
- **PREMIUM ★★ (15종):** ETH/SOL/DOGE/LINK/TON/BCH/FIL/ARB/WIF/AAVE/PENGU/TIA/INJ/NEAR/ENA
- **SKIP:** Short / SOL
- **동시 포지션:** 최대 2개 (자본 총 100% 활용 = 50% × 2)
- **자본 노출:** 동시 2개 × 50% × 10x = notional 자본의 10배
- **일 평균 알림:** 약 8건 (29종)
- **백테스트 1년 (이론):** +4,499% (결함#1 수정 후)
- **현실 수익률 (결함 5개 + fill 률 50% 보정):** **연 +1,900% (자본 19배)**
- **MaxDD 예상:** 22% (안전)
