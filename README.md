...
### 종목 / 시드 / 리스크 (2026-05-17 v1.2 — 12종 + 30x 안전공격)
- **시드:** $300
- **레버리지:** **30배** (원안 유지 + 자본분배로 청산 위험 통제)
- **포지션당 자본:** **25%** ($75/포지션)
- **거래당 리스크 (SL 1회):** -$15.75 (자본 5.25%)
- **종목 (12종):** BTC/ETH/SOL/XRP/DOGE/LINK/ADA/AVAX/SUI/BNB/**TON/HYPE**
  - ★★ PREMIUM: Long/ETH, Long/SOL, Long/DOGE, Long/LINK, **Long/TON (신규)**
  - SKIP: Short/SOL
- **동시 포지션 한도:** 최대 2개 (자본 총 50% 활용)
- **자본 노출:** 동시 2개 × 25% × 30x = notional 자본의 15배
- **백테스트 1년:** 1,139 거래, avg R +0.334, 합계 +382R
- **수익률 (이론):** +462만% / 현실 보정 후 **연 +2~30만% (자본 200~3000배)**
- **MaxDD 예상:** **43%** (청산 마진 확보)
